...
*/
                                Intent intent = new Intent(initialAccountActivity.this, settingUsername.class);
...
/*
                                        userObject newUser = new userObject("ACTIVE", user.getUid().toString(),inviteKey, user.getDisplayName(), photoUrl,
                                                0,0, 0, "normal", "none", "none", "none",
                                                uAccountResetDate, -uAccountResetDate, userStrikes, uName);
...
*/
                                    ...
                                    Intent intent = new Intent(initialAccountActivity.this, tabMainActivity.class);
...
/*
                                        userObject newUser = new userObject("ACTIVE", user.getUid().toString(),inviteKey, user.getDisplayName(), photoUrl,
                                                0,0, 0, "normal", "none", "none", "none",
                                                uAccountResetDate, -uAccountResetDate, userStrikes);
...
*/
                    ...
                    Toast.makeText(initialAccountActivity.this, "Error", Toast.LENGTH_LONG);
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(!task.isSuccessful()){
                    AlertDialog.Builder dialog = new AlertDialog.Builder(initialAccountActivity.this);
